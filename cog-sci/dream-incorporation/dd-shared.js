...
function initDeepDive() {
  const cfg = window.DD_CONFIG || { badge: 'Sleep &amp; Dreams', heroTitle: 'Deep <em>Dive</em>', subtitle: '', logo: 'D<em>D</em>' };
  ...
  shell.innerHTML = `
    ...
    <nav class="sidebar" id="sidebar">
      <div class="sidebar-head"><div class="sidebar-logo">${cfg.logo || 'B<em>G</em>'}</div></div>
