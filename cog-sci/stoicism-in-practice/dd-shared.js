// Deep-dive shared scaffold for Stoicism in Practice
// Expects: DD_CONFIG = { logo, badge, heroTitle, subtitle }, sections[], summaries[], details[]

function initDeepDive() {
  const cfg = window.DD_CONFIG || { logo: 'S<em>t</em>', badge: 'Stoicism in Practice', heroTitle: 'Deep <em>Dive</em>', subtitle: '' };
  ...
  shell.innerHTML = `
    ...
    <nav class="sidebar" id="sidebar">
      <div class="sidebar-head"><div class="sidebar-logo">${cfg.logo}</div></div>
