// Deep-dive shared scaffold for Science of Humor
// Expects: DD_CONFIG = { badge, heroTitle, subtitle, logo }, sections[], summaries[], details[]

function initDeepDive() {
  const cfg = window.DD_CONFIG || { badge: 'Science of Humor', heroTitle: 'Deep <em>Dive</em>', subtitle: '', logo: 'H<em>a</em>' };
  ...
  shell.innerHTML = `
    ...
    <nav class="sidebar" id="sidebar">
      <div class="sidebar-head"><div class="sidebar-logo">${cfg.logo || 'H<em>a</em>'}</div></div>
